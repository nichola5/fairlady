...
@then(u'create room scenario - go to community tab and find community')
def step_impl(context):
    sleep(2)
    context.browser.find_element(By.XPATH,locator.comm_north_tab).click()
    sleep(4)

@then(u'create room scenario - create new room and validating new room')
def step_impl(context):
    ...
    sleep(1)
    context.browser.find_element(By.XPATH,locator.comm_room_save).click()
    sleep(3)
...
@then(u'create room scenario - create and delete post in new room')
def step_impl(context):
...
@then(u'create room scenario - delete room')
def step_impl(context):
...
@then(u'create room scenario - validating deleted room')
def step_impl(context):
    context.browser.find_element(By.XPATH,locator.comm_home).click()
    sleep(3)
    context.browser.find_element(By.XPATH,locator.comm_name).send_keys(Keys.PAGE_DOWN)
...
@then(u'create room scenario - logout')
def step_impl(context):
    context.browser.find_element(By.XPATH,locator.timeline_tab).send_keys(Keys.PAGE_UP)
    sleep(3)
...
@then(u'create room scenario - direct to landing page')
def step_impl(context):
